/* HEADER 
If you use this code dont forget to reference us :) BibTeX: http://www.cs.technion.ac.il/~rani/el-yaniv_bib.html#BegleiterEY04 
...
public StaticDecompositionNode buildStatic(SampleIterator samples){
  ...
  private AbsBinaryDNode buildHuf(SortedMap countMap){
    ...
    while((countMap.size()>1)||
      ...
      if(((Integer)superSym).compareTo((Integer)lowCount.lastKey()) < 0){
            superSym =  (Integer)lowCount.lastKey();
            swap(node2, node1);
      }
