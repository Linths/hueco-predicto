...
public class Test{
  public static void main(String args[]) {
    ...
    try{
      ...
      if(action.equals("learn")){
        ...
        System.out.println(dctw.predict(Integer.parseInt(args[2]),context));
  ...
  // "minimizing the average log-loss is completely equivalent to maximizing a probability assignment for the entire test sequence"
